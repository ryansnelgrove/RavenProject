; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\source\goals\Goal_Think.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__unwindtable$??0Goal_Think@@QAE@PAVRaven_Bot@@@Z DD 0ffffffffH
	...
	DD	01H
	DD	FLAT:__unwindfunclet$??0Goal_Think@@QAE@PAVRaven_Bot@@@Z$10
xdata$x	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\attacktargetgoal_evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\exploregoal_evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\gethealthgoal_evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\getweapongoal_evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_attacktarget.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_getitem.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_explore.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_movetoposition.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_think.cpp
_TEXT	SEGMENT
tv139 = -84						; size = 4
tv146 = -80						; size = 4
tv147 = -76						; size = 4
...
; 204  :   std::list<Goal<Raven_Bot>*>::iterator curG;
...
; 205  :   for (curG=m_SubGoals.begin(); curG != m_SubGoals.end(); ++curG)
...
; 192  :   
; 193  :   std::vector<Goal_Evaluator*>::const_iterator curDes = m_Evaluators.begin();
...
; 194  :   for (curDes; curDes != m_Evaluators.end(); ++curDes)
...
; 195  :   {
; 196  :     (*curDes)->RenderInfo(Vector2D(left, top), m_pOwner);
...
; 182  :    m_SubGoals.push_back(new Goal_MoveToPosition(m_pOwner, pos));
...
; 171  :   if (notPresent(goal_attack_target))
...
; 153  :   if (notPresent(goal_explore))
...
; 156  :     AddSubgoal( new Goal_Explore(m_pOwner));
...
; 162  :   if (notPresent(ItemTypeToGoalType(ItemType)))
...
; 165  :     AddSubgoal( new Goal_GetItem(m_pOwner, ItemType));
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_think.h
...
; 90   : 
; 91   :   if (SubgoalStatus == completed || SubgoalStatus == failed)
...
; 139  :   {
; 140  :     return m_SubGoals.front()->GetType() != GoalType;
...
; 115  :   {
; 116  :     double desirabilty = (*curDes)->CalculateDesirability(m_pOwner);
...
; 119  :     {
; 120  :       best = desirabilty;

	movsd	xmm0, QWORD PTR _desirabilty$4[ebp]
	movsd	QWORD PTR _best$[ebp], xmm0

; 121  :       MostDesirable = *curDes;
...
; 124  : 
; 125  :   assert(MostDesirable && "<Goal_Think::Arbitrate>: no evaluator selected");
...
; 126  : 
; 127  :   MostDesirable->SetGoal(m_pOwner);
...
; 62   :   GoalEvaluators::iterator curDes = m_Evaluators.begin();
...
; 63   :   for (curDes; curDes != m_Evaluators.end(); ++curDes)
...
$T27 = -112						; size = 4
$T28 = -108						; size = 4
_MinigunBias$ = -104					; size = 8
_RevolverBias$ = -96					; size = 8
_SmgBias$ = -88						; size = 8
...
; 37   :   double RevolverBias = RandInRange(LowRangeOfBias, HighRangeOfBias);
	...
	call	?RandInRange@@YANNN@Z			; RandInRange
	add	esp, 16					; 00000010H
	fstp	QWORD PTR _RevolverBias$[ebp]

; 38   :   double MinigunBias = RandInRange(LowRangeOfBias, HighRangeOfBias);
	...
	call	?RandInRange@@YANNN@Z			; RandInRange
	add	esp, 16					; 00000010H
	fstp	QWORD PTR _MinigunBias$[ebp]
...
; 50   :   m_Evaluators.push_back(new GetWeaponGoal_Evaluator(SmgBias,
; 51   : 													 type_smg));
...
; 52   :   m_Evaluators.push_back(new GetWeaponGoal_Evaluator(RevolverBias,
; 53   : 													 type_revolver));
	...
	push	14					; 0000000eH
	sub	esp, 8
	movsd	xmm0, QWORD PTR _RevolverBias$[ebp]
	movsd	QWORD PTR [esp], xmm0
...
; 54   :   m_Evaluators.push_back(new GetWeaponGoal_Evaluator(MinigunBias,
; 55   : 													 type_minigun));
	...
	cmp	DWORD PTR $T2[ebp], 0
	je	SHORT $LN19@Goal_Think
	push	15					; 0000000fH
	sub	esp, 8
	movsd	xmm0, QWORD PTR _MinigunBias$[ebp]
	movsd	QWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR $T2[ebp]
	call	??0GetWeaponGoal_Evaluator@@QAE@NH@Z	; GetWeaponGoal_Evaluator::GetWeaponGoal_Evaluator
	mov	DWORD PTR tv317[ebp], eax
	jmp	SHORT $LN20@Goal_Think
$LN19@Goal_Think:
...
__unwindfunclet$??0Goal_Think@@QAE@PAVRaven_Bot@@@Z$9:
	...
	pop	ecx
	ret	0
__unwindfunclet$??0Goal_Think@@QAE@PAVRaven_Bot@@@Z$10:
	mov	eax, DWORD PTR $T2[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_evaluator.h
