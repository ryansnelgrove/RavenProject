; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\source\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_1IM@BPKLKJHH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAR?$AAy?$AAa?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAE?$AA?9?$AAB?$AAo?$AAo?$AAk?$AAs?$AA?2?$AAA?$AAI@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IM@BPKLKJHH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAR?$AAy?$AAa?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAE?$AA?9?$AAB?$AAo?$AAo?$AAk?$AAs?$AA?2?$AAA?$AAI@
CONST	SEGMENT
??_C@_1IM@BPKLKJHH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAR?$AAy?$AAa?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAE?$AA?9?$AAB?$AAo?$AAo?$AAk?$AAs?$AA?2?$AAA?$AAI@ DB 'C'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\raven_feature.cpp
_TEXT	SEGMENT
tv64 = -16						; size = 4
$T1 = -12						; size = 12
...
; 37   :   switch(WeaponType)
	...
	jmp	DWORD PTR $LN12@GetMaxRoun[edx*4]
$LN7@GetMaxRoun:
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1IM@BPKLKJHH@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAR?$AAy?$AAa?$AAn?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAE?$AA?9?$AAB?$AAo?$AAo?$AAk?$AAs?$AA?2?$AAA?$AAI@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\armory\raven_weapon.h
...
tv194 = -120						; size = 8
_Tweaker$ = -112					; size = 8
_NumBelts$ = -104					; size = 8
_NumRevBullet$ = -96					; size = 8
_NumBullets$ = -88					; size = 8
_NumRockets$ = -80					; size = 8
_NumCartridges$ = -72					; size = 8
_NumSlugs$ = -64					; size = 8
_TotalRoundsCarryable$ = -56				; size = 8
_MaxRoundsForMinigun$ = -48				; size = 8
_MaxRoundsForRevolver$ = -40				; size = 8
_MaxRoundsForSMG$ = -32					; size = 8
...
; 94   :   const double MaxRoundsForShotgun = GetMaxRoundsBotCanCarryForWeapon(type_shotgun);
...
; 95   :   const double MaxRoundsForRailgun = GetMaxRoundsBotCanCarryForWeapon(type_rail_gun);
...
; 96   :   const double MaxRoundsForRocketLauncher = GetMaxRoundsBotCanCarryForWeapon(type_rocket_launcher);
...
; 97   :   const double MaxRoundsForSMG = GetMaxRoundsBotCanCarryForWeapon(type_smg);

	push	13					; 0000000dH
	call	?GetMaxRoundsBotCanCarryForWeapon@@YANH@Z ; GetMaxRoundsBotCanCarryForWeapon
	add	esp, 4
	fstp	QWORD PTR _MaxRoundsForSMG$[ebp]

; 98   :   const double MaxRoundsForRevolver = GetMaxRoundsBotCanCarryForWeapon(type_revolver);

	push	14					; 0000000eH
	call	?GetMaxRoundsBotCanCarryForWeapon@@YANH@Z ; GetMaxRoundsBotCanCarryForWeapon
	add	esp, 4
	fstp	QWORD PTR _MaxRoundsForRevolver$[ebp]

; 99   :   const double MaxRoundsForMinigun = GetMaxRoundsBotCanCarryForWeapon(type_minigun);

	push	15					; 0000000fH
	call	?GetMaxRoundsBotCanCarryForWeapon@@YANH@Z ; GetMaxRoundsBotCanCarryForWeapon
	add	esp, 4
	fstp	QWORD PTR _MaxRoundsForMinigun$[ebp]

; 100  :   const double TotalRoundsCarryable = MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher;
...
; 101  : 
; 102  :   double NumSlugs      = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_rail_gun);
...
; 103  :   double NumCartridges = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_shotgun);
...
; 104  :   double NumRockets    = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_rocket_launcher);
...
; 105  :   double NumBullets    = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_smg);
	...
	call	?GetAmmoRemainingForWeapon@Raven_WeaponSystem@@QAEHI@Z ; Raven_WeaponSystem::GetAmmoRemainingForWeapon
	cvtsi2sd xmm0, eax
	movsd	QWORD PTR _NumBullets$[ebp], xmm0

; 106  :   double NumRevBullet  = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_revolver);
	...
	call	?GetAmmoRemainingForWeapon@Raven_WeaponSystem@@QAEHI@Z ; Raven_WeaponSystem::GetAmmoRemainingForWeapon
	cvtsi2sd xmm0, eax
	movsd	QWORD PTR _NumRevBullet$[ebp], xmm0

; 107  :   double NumBelts      = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_minigun);
	...
	call	?GetAmmoRemainingForWeapon@Raven_WeaponSystem@@QAEHI@Z ; Raven_WeaponSystem::GetAmmoRemainingForWeapon
	cvtsi2sd xmm0, eax
	movsd	QWORD PTR _NumBelts$[ebp], xmm0

; 108  : 
; 109  :   //the value of the tweaker (must be in the range 0-1) indicates how much
; 110  :   //desirability value is returned even if a bot has not picked up any weapons.
; 111  :   //(it basically adds in an amount for a bot's persistent weapon -- the blaster)
; 112  :   const double Tweaker = 0.1;

	movsd	xmm0, QWORD PTR __real@3fb999999999999a
	movsd	QWORD PTR _Tweaker$[ebp], xmm0

; 113  : 
; 114  :   return Tweaker + (1-Tweaker)*(NumSlugs + NumCartridges + NumRockets + NumBullets + NumRevBullet + NumBelts)/(MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher + MaxRoundsForSMG + MaxRoundsForRevolver + MaxRoundsForMinigun);
	...
	addsd	xmm1, QWORD PTR _NumBullets$[ebp]
	addsd	xmm1, QWORD PTR _NumRevBullet$[ebp]
	addsd	xmm1, QWORD PTR _NumBelts$[ebp]
	mulsd	xmm0, xmm1
	...
	addsd	xmm1, QWORD PTR _MaxRoundsForSMG$[ebp]
	addsd	xmm1, QWORD PTR _MaxRoundsForRevolver$[ebp]
	addsd	xmm1, QWORD PTR _MaxRoundsForMinigun$[ebp]
	divsd	xmm0, xmm1
...
; 76   :   //grab a pointer to the gun (if the bot owns an instance)
; 77   :   Raven_Weapon* wp = pBot->GetWeaponSys()->GetWeaponFromInventory(WeaponType);
...
; 80   :   {
; 81   :     return wp->NumRoundsRemaining() / GetMaxRoundsBotCanCarryForWeapon(WeaponType);
...
; 122  :   return (double)pBot->Health() / (double)pBot->MaxHealth();
