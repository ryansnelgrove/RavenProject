; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\Buckland_Chapter7 to 10_Raven\goals\Raven_Feature.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG161162 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG161164 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG161166 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG161168 DB	'SMG_MaxRoundsCarried', 00H
	ORG $+3
$SG161172 DB	'trying to calculate  of unknown weapon', 00H
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\buckland_chapter7 to 10_raven\goals\raven_feature.cpp
_TEXT	SEGMENT
tv64 = -16						; size = 4
$T1 = -12						; size = 12
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\buckland_chapter7 to 10_raven\armory\raven_weapon.h
...
; 89   :   const double TotalRoundsCarryable = MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher;
...
; 90   : 
; 91   :   double NumSlugs      = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_rail_gun);
...
; 92   :   double NumCartridges = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_shotgun);
...
; 93   :   double NumRockets    = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_rocket_launcher);
...
; 94   :   double NumBullets    = (double)pBot->GetWeaponSys()->GetAmmoRemainingForWeapon(type_smg);
...
; 95   : 
; 96   :   //the value of the tweaker (must be in the range 0-1) indicates how much
; 97   :   //desirability value is returned even if a bot has not picked up any weapons.
; 98   :   //(it basically adds in an amount for a bot's persistent weapon -- the blaster)
; 99   :   const double Tweaker = 0.1;

	movsd	xmm0, QWORD PTR __real@3fb999999999999a
	movsd	QWORD PTR _Tweaker$[ebp], xmm0

; 100  : 
; 101  :   return Tweaker + (1-Tweaker)*(NumSlugs + NumCartridges + NumRockets)/(MaxRoundsForShotgun + MaxRoundsForRailgun + MaxRoundsForRocketLauncher);
...
; 109  :   return (double)pBot->Health() / (double)pBot->MaxHealth();
