; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\source\goals\GetWeaponGoal_Evaluator.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\common\misc\stream_utility_functions.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\getweapongoal_evaluator.cpp
_TEXT	SEGMENT
tv144 = -140						; size = 4
tv145 = -136						; size = 4
tv142 = -132						; size = 4
...
; 65   :   switch(m_iWeaponType)
	...
	ja	SHORT $LN7@RenderInfo
	mov	eax, DWORD PTR tv68[ebp]
	jmp	DWORD PTR $LN18@RenderInfo[eax*4]
$LN6@RenderInfo:
...
; 68   :     s="RG: ";break;
	...
	jmp	SHORT $LN7@RenderInfo
$LN5@RenderInfo:

; 69   :   case type_rocket_launcher:
; 70   :     s="RL: "; break;

	push	OFFSET $SG153191
	lea	ecx, DWORD PTR _s$[ebp]
	call	??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator=
	jmp	SHORT $LN7@RenderInfo
$LN4@RenderInfo:
...
; 74   : 	s = "MG"; break;
	...
	push	OFFSET $SG153195
	lea	ecx, DWORD PTR _s$[ebp]
	call	??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator=
	jmp	SHORT $LN7@RenderInfo
$LN2@RenderInfo:

; 75   :   case type_revolver:
; 76   : 	s = "PI"; break;

	push	OFFSET $SG153197
	lea	ecx, DWORD PTR _s$[ebp]
	call	??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator=
	jmp	SHORT $LN7@RenderInfo
$LN1@RenderInfo:

; 77   :   case type_minigun:
; 78   : 	s = "MI"; break;

	push	OFFSET $SG153199
	lea	ecx, DWORD PTR _s$[ebp]
	call	??4?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV01@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator=
$LN7@RenderInfo:
...
; 80   : 
; 81   :   
; 82   :   gdi->TextAtPos(Position, s + ttos(CalculateDesirability(pBot), 2));
...
; 83   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN17@RenderInfo
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
