; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\source\goals\Goal_GetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_wander.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\source\goals\goal_getitem.cpp
_TEXT	SEGMENT
tv156 = -48						; size = 4
tv170 = -44						; size = 4
tv169 = -40						; size = 4
...
; 90   :   //first, pass the message down the goal hierarchy
; 91   :   bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 102  : 
; 103  :       AddSubgoal(new Goal_FollowPath(m_pOwner,
...
; 105  : 
; 106  :       //get the pointer to the item
; 107  :       m_pGiverTrigger = static_cast<Raven_Map::TriggerType*>(msg.ExtraInfo);
...
; 110  : 
; 111  : 
; 112  :     case Msg_NoPathAvailable:
; 113  : 
; 114  :       m_iStatus = failed;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+12], 3

; 115  : 
; 116  :       return true; //msg handled
...
; 79   :   {
; 80   :     //process the subgoals
; 81   :     m_iStatus = ProcessSubgoals();
...
; 55   :   
; 56   :   m_pGiverTrigger = 0;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+32], 0

; 57   :   
; 58   :   //request a path to the item
; 59   :   m_pOwner->GetPathPlanner()->RequestPathToItem(m_iItemToGet);
...
; 60   : 
; 61   :   //the bot may have to wait a few update cycles before a path is calculated
; 62   :   //so for appearances sake it just wanders
; 63   :   AddSubgoal(new Goal_Wander(m_pOwner));
...
; 133  :   if (m_pGiverTrigger &&
; 134  :       !m_pGiverTrigger->isActive() &&
; 135  :       m_pOwner->hasLOSto(m_pGiverTrigger->Pos()) )
...
; 15   :   switch(gt)
	...
	jmp	DWORD PTR $LN13@ItemTypeTo[edx*4]
$LN8@ItemTypeTo:
...
; 36   : 
; 37   :   case type_revolver:
; 38   : 
; 39   : 	return goal_get_revolver;
...
; 40   : 
; 41   :   case type_minigun:
; 42   : 
; 43   : 	return goal_get_minigun;
