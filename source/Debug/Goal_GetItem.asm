; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.40629.0 
	...
	TITLE	C:\Users\Ryan\Desktop\E-Books\AI\Lua Project 2013\Buckland_Chapter7 to 10_Raven\goals\Goal_GetItem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG156382 DB	'Goal_GetItem cannot determine item type', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
CONST	ENDS
PUBLIC	_hypot
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\common\triggers\trigger.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\buckland_chapter7 to 10_raven\goals\goal_wander.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File c:\users\ryan\desktop\e-books\ai\lua project 2013\buckland_chapter7 to 10_raven\goals\goal_getitem.cpp
_TEXT	SEGMENT
tv156 = -48						; size = 4
tv170 = -44						; size = 4
tv169 = -40						; size = 4
...
; 82   :   //first, pass the message down the goal hierarchy
; 83   :   bool bHandled = ForwardMessageToFrontMostSubgoal(msg);
...
; 84   : 
; 85   :   //if the msg was not handled, test to see if this goal can handle it
; 86   :   if (bHandled == false)
...
; 89   :     {
; 90   :     case Msg_PathReady:
; 91   : 
; 92   :       //clear any existing goals
; 93   :       RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 94   : 
; 95   :       AddSubgoal(new Goal_FollowPath(m_pOwner,
...
; 102  : 
; 103  : 
; 104  :     case Msg_NoPathAvailable:
; 105  : 
; 106  :       m_iStatus = failed;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+12], 3

; 107  : 
; 108  :       return true; //msg handled
...
; 71   :   {
; 72   :     //process the subgoals
; 73   :     m_iStatus = ProcessSubgoals();
...
; 47   :   
; 48   :   m_pGiverTrigger = 0;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+32], 0

; 49   :   
; 50   :   //request a path to the item
; 51   :   m_pOwner->GetPathPlanner()->RequestPathToItem(m_iItemToGet);
...
; 52   : 
; 53   :   //the bot may have to wait a few update cycles before a path is calculated
; 54   :   //so for appearances sake it just wanders
; 55   :   AddSubgoal(new Goal_Wander(m_pOwner));
...
; 125  :   if (m_pGiverTrigger &&
; 126  :       !m_pGiverTrigger->isActive() &&
; 127  :       m_pOwner->hasLOSto(m_pGiverTrigger->Pos()) )
...
; 15   :   switch(gt)
	...
	jmp	DWORD PTR $LN11@ItemTypeTo[edx*4]
$LN6@ItemTypeTo:
...
; 36   : 
; 37   :   default: throw std::runtime_error("Goal_GetItem cannot determine item type");

	push	OFFSET $SG156382
	lea	ecx, DWORD PTR $T1[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T1[ebp]
