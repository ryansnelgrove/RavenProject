...
Belt::Belt(Raven_Bot* shooter, Vector2D target) :
...
shooter->Pos(),
shooter->Facing(),
script->GetInt("Belt_Damage"),
script->GetDouble("Belt_Scale"),
script->GetDouble("Belt_MaxSpeed"),
script->GetDouble("Belt_Mass"),
script->GetDouble("Belt_MaxForce"))
{
