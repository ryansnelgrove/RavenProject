...
Bullet::Bullet(Raven_Bot* shooter, Vector2D target):
	...
	Raven_Projectile(target,
                         ...
                         shooter->Pos(),
                         shooter->Facing(),
                         script->GetInt("Bullet_Damage"),
                         script->GetDouble("Bullet_Scale"),
                         script->GetDouble("Bullet_MaxSpeed"),
                         script->GetDouble("Bullet_Mass"),
                         script->GetDouble("Bullet_MaxForce"))
{
