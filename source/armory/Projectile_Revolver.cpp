...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
RevBullet::RevBullet(Raven_Bot* shooter, Vector2D target) :
...
shooter->Pos(),
shooter->Facing(),
script->GetInt("RevBullet_Damage"),
script->GetDouble("RevBullet_Scale"),
script->GetDouble("RevBullet_MaxSpeed"),
script->GetDouble("RevBullet_Mass"),
script->GetDouble("RevBullet_MaxForce"))
{
